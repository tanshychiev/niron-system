...
urlpatterns = [
    ...
    # Supplier quick-create used by Stock In form
    path(
        "suppliers/ajax-create/",
        inventory_supplier_ajax_create,
        name="inventory_supplier_ajax_create",
    ),

    # Batch actions
    path(
        "batches/<int:pk>/receive/",
        inventory_batch_confirm_received,
        name="inventory_batch_confirm_received",
    ),
    path(
